package com.harshchhikara.sudokusolver;
...
class SudokuBoard extends View {
    ...
    private void colorCell(Canvas canvas, int r,int c){
        if(solver.getSelectedColumn()!=-1 && solver.getSelectedRow() !=-1){
            canvas.drawRect((c-1)*cellSize, 0,c*cellSize,cellSize*9,cellFillColorPaint);

            canvas.drawRect(0, (r-1)*cellSize,cellSize*9,r*cellSize,cellFillColorPaint);
